...
- forbidden_elements: 병원, 은행, 미용실, 시장, 새로운 인물, 읽을 수 있는 글자, 로고
...
- block: B01
- purpose: A-roll
- scene_goal: 딸이 어머니의 이상함을 알아차린다
- characters: 김정애, 김민서
- character_reference: EP01_CHARACTER_BIBLE 김정애, 김민서
- location: 집 거실
- allowed_elements: 낡은 소파, 작은 탁자, 부드러운 아침빛
- forbidden_elements: 병원, 은행, 미용실, 시장, 새로운 인물, 읽을 수 있는 글자, 로고
- shot_size: medium two-shot
- camera_angle: slight side angle
- camera_movement: static camera with subtle slow push-in
...
- block: B02
- purpose: A-roll
- scene_goal: 병원으로 함께 가자는 결정을 보여준다
- characters: 김정애, 김민서
- character_reference: EP01_CHARACTER_BIBLE 김정애, 김민서
- location: 집 현관
- allowed_elements: 현관문, 작은 갈색 가방, 부드러운 실내 조명
- forbidden_elements: 병원 진료실, 은행, 미용실, 시장, 새로운 인물, 읽을 수 있는 글자, 로고
- shot_size: close medium shot
- camera_angle: eye-level side angle
...
- block: B03
- purpose: A-roll
- scene_goal: 병원 진료실에서 결과를 듣는 긴장감을 보여준다
- characters: 김정애, 김민서, 박의사
- character_reference: EP01_CHARACTER_BIBLE 김정애, 김민서, 박의사
- location: 병원 진료실
- allowed_elements: 의사 책상, 진료 의자, 닫힌 빈 진료 파일, 차분한 병원 조명
- forbidden_elements: 수술실, 응급실, 은행, 미용실, 읽을 수 있는 글자, 로고, 과도한 의료 장비, 추가 의료진
- shot_size: wide medium shot
- camera_angle: eye-level front-side angle
- camera_movement: static camera
- action: 의사가 조용히 설명하고 정애와 민서가 나란히 앉아서 듣는다
- emotion: 긴장, 두려움, 절제
...
- forbidden_elements: 새로운 인물, 읽을 수 있는 글자, 로고, 과장된 눈물, 다른 장소
- shot_size: close-up
...
- character_reference: EP01_CHARACTER_BIBLE 김정애, 김민서
- location: 조용한 병원 복도
- allowed_elements: 부드러운 복도 조명, 손을 잡은 두 사람, 차분하고 비어 있는 배경
- forbidden_elements: 은행, 미용실, 시장, 새로운 인물, 읽을 수 있는 글자, 로고, 휠체어, 응급 상황
- shot_size: medium back shot
- camera_angle: rear eye-level angle
- camera_movement: slow following shot
- action: 민서가 어머니의 손을 잡고 천천히 복도를 걷는다
...
1. 모든 컷이 대본 블록과 연결되었는가
2. 모든 컷의 캐릭터 참조가 지정되었는가
3. 장소와 금지 장소가 명확한가
